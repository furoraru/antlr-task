...
public interface LabeledExprListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ShiftLeftRight}
	 * labeled alternative in {@link LabeledExprParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterShiftLeftRight(LabeledExprParser.ShiftLeftRightContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ShiftLeftRight}
	 * labeled alternative in {@link LabeledExprParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitShiftLeftRight(LabeledExprParser.ShiftLeftRightContext ctx);
	/**
